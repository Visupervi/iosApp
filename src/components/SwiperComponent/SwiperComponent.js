  ...
  return (
    <>
      <View
                        ...
                        card.age ?
                          <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-around'}}>
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                              ...
                              <IconFont style={{fontSize: 18, color: card.gender === '女' ? '#b564bf' : 'red'}}
        ...
        {/* 两个小图标 */}
        {
          props.cards.length > 0 && currentIndex < props.cards.length && props.isUrl ?
            <View
              style={{
                flexDirection: 'row',
            ...
            >
              <TouchableOpacity
                ...
                style={{
                  backgroundColor: '#ebc869', width: 60,
                  height: 60, borderRadius: 30, alignItems: 'center', justifyContent: 'center',
                }}
              >
                <IconFont style={{fontSize: 30, color: '#fff'}} name="iconbuxihuan"/>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                  handlerIsLike('like');
                ...
                style={{
                  backgroundColor: '#fd5213', width: 60,
                  height: 60, borderRadius: 30, alignItems: 'center', justifyContent: 'center',
                }}
              >
                <IconFont style={{fontSize: 30, color: '#fff'}} name="iconxihuan"/>
              </TouchableOpacity>
            </View> : <></>
        }
