...
// 获取今日佳人数据
export const getPerfectGirl = (data) => $fetch('/api/friends/todayBest', data, 'get');

// 获取推荐数据/api/friends/recommend
export const getRecommendsList = (data) => $fetch('/api/friends/recommend', data, 'get');
...
// 获取试题
export const getQuestionList = data => $fetch("/api/friends/questionList", data, "get");

//获取朋友动态
export const getFriendsDynamic = data => $fetch("/api/friends/detail", data, "get");

//获取消息列表
export const getMessageList = data => $fetch("/api/message/messageList",data,"get");
