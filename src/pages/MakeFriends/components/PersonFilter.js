    ...
    <>
      <View style={{
        ...
        <View style={{flexDirection: 'row', marginTop: 30}}>
          <Text style={{color: '#777', fontSize: 18, width: 140}}>就近登录时间：</Text>
          <Text onPress={handlerSelectTime}>{lastDate || '请选择'}</Text>
        </View>
        {/*距离选择*/}
        <View style={{marginTop: 30}}>
          <Text style={{color: '#777', fontSize: 18, width: 100}}>距离{distance}KM</Text>
          <Slider
            value={distance}
            minimumValue={0}
            maximumValue={10}
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 30}}>
          ...
          <Text onPress={handlerCity} style={{color: '#777', fontSize: 18}}>{city || '请选择'}</Text>
        </View>
        {/*学历选择*/}
        <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 30}}>
          <Text style={{color: '#777', fontSize: 18, width: 80}}>学历:</Text>
          <Text onPress={handlerEducation} style={{color: '#777', fontSize: 18}}>{education || '请选择'}</Text>
        </View>
        {/*确认按钮*/}
        <View style={{width: '40%', height: 40, alignSelf: 'center', marginTop: 50}}>
          <LinearGradientBtn
            color={['#9b63cd', '#e0708c']}
