    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ color: "#fff" }}>usestate里面的set方法是异步的，但是我想把他变成同步的，该怎么做？？change => setfields => fields改变 => 组件从新render
              是这样一个流程。
          ...
          <View style={{
            ...
            <LinearGradientBtn style={{ color:"#fff"}} color={['#9b63cd', '#e0708c']} onPress={handlerContinue}>继续测试</LinearGradientBtn>
          </View>
        </ImageBackground>
      </ImageBackground>
    </>
